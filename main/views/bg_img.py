...
class bg_img(tk.Frame):
    ...
    def create_page(self):
        ...
        self.p_top = ft.get_img_resized(r"main/resources/images/deck_preview/deck_bg_top_j.png",self.window.DECK_IMG_SCALE_FACTOR)
        self.p_mid = ft.get_img_resized(r"main/resources/images/deck_preview/deck_bg_mid_j.png",self.window.DECK_IMG_SCALE_FACTOR)
        self.p_end = ft.get_img_resized(r"main/resources/images/deck_preview/deck_bg_end_j.png",self.window.DECK_IMG_SCALE_FACTOR)
        ...
        self.can_bg.create_image(0,self.window.TOP_HEIGHT,anchor='nw',image=self.p_mid)
        self.c_end = self.can_bg.create_image(0,self.window_height-self.window.BOTTOM_HEIGHT,anchor='nw',image=self.p_end)
