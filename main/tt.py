...
if __name__ == "__main__":
    ...
    print("GameId:",hex(read_multi_bytes(pm,gi+0x28,[0x48],8)))
    ...
    for i in range(0,2):
        ...
        # print("battleDeckAdd:",hex(read_int64(pm,gi+0x20,[0x60,0x18,0x20+i*0x8,0x28])))
        # print("p{0}-abilityId:".format(i+1),read_multi_bytes(pm,gi+0x20,[0x60,0x18,0x20+i*0x8,0x28,0x40],0x4))
        print("p{0}-leaderId:".format(i+1),read_multi_bytes(pm,gi+0x20,[0x60,0x18,0x20+i*0x8,0x28,0x14],0x4))
        print("p{0}-stratagem:".format(i+1),read_multi_bytes(pm,gi+0x20,[0x60,0x18,0x20+i*0x8,0x28,0x1c],0x4))
        print("p{0}-factionId:".format(i+1),Faction(read_multi_bytes(pm,gi+0x20,[0x60,0x18,0x20+i*0x8,0x28,0x10],0x4)))
